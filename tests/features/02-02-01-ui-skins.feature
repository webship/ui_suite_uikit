Feature: UI Skins design tokens and color modes
  ...
  Scenario: A CSS variable changes the UIkit primary color
    ...
    Given I am logged in as the Drupal administrator
     When I set the UI Skins CSS variable "uk-global-primary-background" of the UIkit theme to "#1e87f0"
      And I am an anonymous user
      And I go to "/user/login"
     Then the computed style "background-color" of "#edit-submit" should be "rgb(30, 135, 240)"
