/**
 * @file
 * Webship-js (Cucumber-js + Playwright) configuration for UI Suite UIkit.
 *
 * Environment:
 * - LAUNCH_URL: the Drupal site running the theme
 *   (default https://uikittest.ddev.site).
 ...
 *   (default ~/workspace/test/uikittest).
 */
module.exports = {
  default: {
    timeout: 60000,
    ...
    worldParameters: {
      launchUrl: process.env.LAUNCH_URL || 'https://uikittest.ddev.site',
      minWaitTime: {
        page: 1000,
        before_scenario: 0,
        after_scenario: 0,
