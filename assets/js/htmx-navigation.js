/**
 * @file
 * HTMX navigation for UI Suite UIkit.
 *
...
((Drupal, drupalSettings, htmx) => {
  ...
  Drupal.uiSuiteUikit = Drupal.uiSuiteUikit || {};
   ...
   */
  Drupal.uiSuiteUikit.isExcludedFromHtmx = (url, element = null) => {
  ...
  htmx.on('htmx:beforeRequest', (event) => {
    ...
    if (url && Drupal.uiSuiteUikit.isExcludedFromHtmx(url, detail.elt)) {
