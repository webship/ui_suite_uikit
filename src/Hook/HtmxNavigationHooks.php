...
/**
 * HTMX navigation of UI Suite UIkit, without custom JavaScript.
 *
...
class HtmxNavigationHooks implements TrustedCallbackInterface {
   ...
   */
  public const string FORM_ACTION_PLACEHOLDER = 'form_action_p_ui_suite_uikit_htmx_navigation';

  /**
   * The ID of the live region announcing the page title.
   */
  public const string ANNOUNCER_ID = 'ui-suite-uikit-htmx-announcer';
  ...
  public function formAlter(array &$form, FormStateInterface $form_state): void {
    $form['#cache']['tags'] = Cache::mergeTags($form['#cache']['tags'] ?? [], ['config:ui_suite_uikit.settings']);
    if (!$this->enabled()) {
      return;
    }
